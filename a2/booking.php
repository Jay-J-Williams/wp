...
<html lang='en'>
  ...
  <body>
    ...
    <main>
        <article id='ACTInfo'>
            <iframe src="https://www.youtube.com/embed/d9MyW72ELq0" class='YTVideo' title="Avatar: The Way of Water | Official Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            <h1>Synopsis</h1>
        ...
        <article id='RMCInfo'>
            <iframe src="https://www.youtube.com/embed/Ols03gpTjW4" class='YTVideo' title="Weird: The Al Yankovic Story - Official Trailer (2022) Daniel Radcliffe, Quinta Brunson" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            <h1>Synopsis</h1>
        ...
        <article id='FAMInfo'>
            <iframe src="https://www.youtube.com/embed/Y5zqweZAEKI" class='YTVideo' title="PUSS IN BOOTS: THE LAST WISH | Official Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            <h1>Synopsis</h1>
        ...
        <article id='AHFInfo'>
            <iframe src="https://www.youtube.com/embed/-7OCX98JgGk" class='YTVideo' title="Margrete Queen Of The North - Official Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            <h1>Synopsis</h1>
        ...
        <form id='MovieCode' action='booking.php' method='get'>
        </form>
