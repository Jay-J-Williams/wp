    ...
    <main>
        ...
        <form action='' method='post' id='BookingForm'>
            ...
            <fieldset>
                ...
                <input type='text' name='user[name]' placeholder='Full Name' pattern="[A-Za-z\W+]{1,64}" value='<?php preFillText("name"); ?>' required>
                ...
                <br>
                <input type='email' name='user[email]' placeholder='Email' value='<?php preFillText("email"); ?>' required>
                ...
                <br>
                <input type='tel' name='user[mobile]' placeholder='Mobile Number' pattern="[0-9]{10}" value='<?php preFillText("mobile"); ?>' required>
